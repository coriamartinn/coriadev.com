...
export function About() {
  return (
    <section
      id="sobre-mi"
      className="py-20 md:py-32 bg-[#1a1a1a] relative overflow-hidden"
    >
      {/* Decorative Elements */}
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-4 md:space-y-6 order-1 md:order-2">
            <div className="inline-block">
              <span className="text-[#ff2637] uppercase tracking-wider text-sm">
                Sobre Mí
              </span>
            ...
            <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
              <p>
                Enfoque profesional respaldado por formación académica en la{" "}
                <span className="text-[#ff2637] font-semibold">
                  Tecnicatura Universitaria en Programación (UTN)
                </span>
                , garantizando bases sólidas en cada proyecto de desarrollo.
              </p>

              <p>
                Especialización en la creación de soluciones digitales a medida
                y escalables. El flujo de trabajo se estructura sobre tres
                pilares fundamentales: escritura de código limpio para un
                rendimiento óptimo, arquitecturas escalables que acompañan el
                crecimiento del negocio, y visión estratégica integral.
              </p>

              <p>
                El objetivo es transformar los requerimientos técnicos y
                comerciales en una{" "}
                <span className="text-[#ff2637] font-semibold">
                  herramienta digital potente{" "}
                </span>
                orientada a la resolución eficiente de problemas reales.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3 md:gap-4 pt-4">
              ...
              <div className="bg-[#0d0d0d]/50 border border-[#ff2637]/20 rounded-lg px-4 md:px-6 py-2 md:py-3 flex-1 min-w-[100px]">
                <div className="text-[#ff2637] text-xl md:text-2xl">
                  Software Developer
                </div>
                <div className="text-gray-400 text-xs md:text-sm">
                  Perfil Técnico
