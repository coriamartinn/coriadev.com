...
const projects: Project[] = [
  {
    ...
    description:
      "Landing page corporativa diseñada para transmitir confianza y autoridad. Optimizada para la captación de clientes (Leads) con llamadas a la acción estratégicas y diseño responsive de alto impacto.",
  ...
  },
  {
    ...
    description:
      "Portfolio digital para empresa de construcción. Galería de proyectos interactiva y optimización de imágenes para una carga veloz. Diseño robusto que refleja la solidez de la marca.",
    tech: ["React", "Vite", "UX/UI Design"],
    image: "/jc-construcciones.png",
    liveUrl: "https://josealegreconstrucciones.com/",
    repoUrl: "https://github.com/tu-usuario/landing-constructora",
  },
  {
    title: "Sistema de Gestión Psicopedagogía (MVP)",
    description:
      "Aplicación web completa para la administración de historias clínicas y pacientes. Incluye control de sesiones, notas evolutivas privadas y agenda digital. Seguridad de datos garantizada.",
  ...
  },
  {
    ...
    description:
      "Aplicación web diseñada para manejar hamburgueserias o restaurantes, tiene sector pedidos, cocina, estadisticas diarias y reportes o finanzas. Tambien se puede conectar la comandera y tiene todo un gran control perfecto del restaurante.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 md:mb-24">
          <div className="inline-block">
            <span className="text-[#ff2637] uppercase tracking-wider text-sm font-semibold">
              Portafolio
            </span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group relative bg-[#1a1a1a] rounded-2xl overflow-hidden border border-gray-800 hover:border-[#ff2637]/50 transition-colors duration-300 flex flex-col"
            >
              {/* Imagen del proyecto */}
              ...
              <div className="p-6 md:p-8 flex flex-col flex-grow">
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tech.map((t, i) => (
                    <span
                      key={i}
                      className="text-xs font-medium text-[#ff2637] bg-[#ff2637]/10 px-2 py-1 rounded"
                    >
                      {t}
                    </span>
                  ))}
